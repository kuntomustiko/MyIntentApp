...
public class MoveForResultActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //  kita menggunakan radiogroup sebagai parent pada obyek-obyek radiobutton.
    //  Secara otomatis kita bisa mendapatkan mana obyek radiobutton yang dipilih dengan rgNumber.getCheckedRadioButtonId().
    @Override
